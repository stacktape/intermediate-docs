...
<PreviousNext
  left={{ url: "/getting-started/deploying-using-CLI/", title: "Deploying using CLI" }}
  right={{ url: "/getting-started/deploying-using-3rd-party-CI/", title: "Deploying using 3rd party CI" }}
/>
