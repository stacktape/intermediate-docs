...
- increases the read throughput\n- increases availability. Replica node can become the primary node in case of primary node failure.\n\n- Load balancing between replicas is automatically handled by AWS.\n- When there are multiple shards, this number specifies the number of replicas for each **shard cluster**.\n<div class="highlight-wrapper">
  ...
  <div>Changing `numReplicaNodes` when sharding is enabled is not possible and will result in error.\n\n</div>
</div>
...
[AWS Docs](/resources/redis-clusters/#sharded-cluster).\n<div class="highlight-wrapper">
  <div style="margin-right: 16px;line-height: 0px;">
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ED8B00" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    </path>
    - </line>
