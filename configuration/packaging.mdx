...
This section applies to [web services](/compute-resources/web-services), [private services](/compute-resources/private-services), [worker services](/compute-resources/worker-services), [multi-container workloads](/compute-resources/multi-container-workloads), and [batch jobs](/compute-resources/batch-jobs).
...
*   Secrets can be managed with Stacktape. For more information, see the [secrets documentation](/security-resources/secrets).
