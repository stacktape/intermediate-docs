...
<SdkMethodsApiReference
  ...
  sortedArgs={[
    {
      description: "#### Password of the user in the userpool",
      allowedTypes: ["string"],
      required: true,
      name: "password",
      shortDescription: "<p> Password of the user in the userpool</p>\n"
    },
    {
      description:
    ...
    {
      description: "#### Username of the user in the userpool",
      allowedTypes: ["string"],
      required: true,
      name: "username",
      shortDescription: "<p> Username of the user in the userpool</p>\n"
    },
    {
      description:
