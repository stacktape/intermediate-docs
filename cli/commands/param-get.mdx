...
Retrieves specified parameter of the resource deployed in specified stack
...
```bash
stacktape param:get --region <<region>> --resourceName <<resourceName>> --paramName <<paramName>>
```
...
<CliCommandsApiReference
  command="param:get"
  sortedArgs={[
    { allowedTypes: ["string"], alias: "pn", required: true, name: "paramName", shortDescription: "" },
    {
