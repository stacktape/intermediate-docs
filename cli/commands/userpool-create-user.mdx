...
<CliCommandsApiReference
  ...
  sortedArgs={[
    ...
    {
      description:
        "#### Automatically confirms the created user.\n---\n- The user won't need to be validate using email or phone to become active.",
      allowedTypes: ["boolean"],
      alias: "acu",
      required: false,
      name: "autoConfirmUser",
      shortDescription: "<p> Automatically confirms the created user.</p>\n",
      longDescription:
        "<ul>\n<li>The user won&#39;t need to be validate using email or phone to become active.</li>\n</ul>\n"
    },
    {
      description:
