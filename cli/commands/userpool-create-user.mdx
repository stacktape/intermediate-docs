...
Creates a new user in a specified user pool.

You will be prompted to enter the user's details interactively.
...
```bash
stacktape userpool:create-user --stage <<stage>> --region <<region>> --userPoolName <<userPoolName>>
```

# API reference

<CliCommandsApiReference
  command="userpool:create-user"
  sortedArgs={[
    {
      description:
    ...
    {
      description:
        "#### Auto-Confirm User\n\n---\n\nIf `true`, automatically confirms the user without requiring email or phone verification.",
      allowedTypes: ["boolean"],
      alias: "acu",
      required: false,
      name: "autoConfirmUser",
      shortDescription: "<p> Auto-Confirm User</p>\n",
      longDescription:
        "<p>If <code>true</code>, automatically confirms the user without requiring email or phone verification.</p>\n"
    },
    {
      description:
