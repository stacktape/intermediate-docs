...
Creates a secret that is securely stored in AWS.

<br />

- This secret can be then referenced using `$Secret('secret-name')` directive.
- Useful for storing sensitive data like passwords, API keys or credentials.
