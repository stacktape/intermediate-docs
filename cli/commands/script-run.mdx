...
<CliCommandsApiReference
  ...
  sortedArgs={[
    ...
    {
      description: "#### Name of the deployed resource to assume role of during script execution",
      allowedTypes: ["string"],
      alias: "aror",
      required: false,
      name: "assumeRoleOfResource",
      shortDescription: "<p> Name of the deployed resource to assume role of during script execution</p>\n"
    },
    {
      description:
