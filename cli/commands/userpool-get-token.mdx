...
Prints tokens (ID, access, and refresh) for a specified user in a user pool.

You will be prompted to enter the user's username and password.
...
<CliCommandsApiReference
  ...
  sortedArgs={[
    ...
    {
      description:
        "#### Token Type\n\n---\n\nThe type of token to print to the console.\n\n- `accessToken`: Used to access protected resources.\n- `idToken`: Contains information about the user's identity.\n- `refreshToken`: Used to obtain a new token after the current one expires.",
      allowedTypes: ["string"],
      allowedValues: ["accessToken", "idToken", "refreshToken"],
      alias: "tt",
      required: true,
      name: "tokenType",
      shortDescription: "<p> Token Type</p>\n",
      longDescription:
        "<p>The type of token to print to the console.</p>\n<ul>\n<li><code>accessToken</code>: Used to access protected resources.</li>\n<li><code>idToken</code>: Contains information about the user&#39;s identity.</li>\n<li><code>refreshToken</code>: Used to obtain a new token after the current one expires.</li>\n</ul>\n"
    },
    {
      description: "#### User Pool Name\n\n---\n\nThe name of the user pool as defined in your configuration file.",
      allowedTypes: ["string"],
      alias: "upn",
      required: true,
      name: "userPoolName",
      shortDescription: "<p> User Pool Name</p>\n",
      longDescription: "<p>The name of the user pool as defined in your configuration file.</p>\n"
    },
    {
      description:
