...
Prints tokens (id token, access token and refresh token) for the specified user in the specified userpool to the
console.
...
<CliCommandsApiReference
  ...
  sortedArgs={[
    ...
    {
      description:
        "#### Type of the token the print to the console.\n---\nAvailable options:\n- `accessToken`: used to access protected services or endpoints\n- `idToken`: used to retrieve information about the identity of the bearer (user/other entity)\n- `refreshToken`: used to get new token after the current expire",
      allowedTypes: ["string"],
      allowedValues: ["accessToken", "idToken", "refreshToken"],
      alias: "tt",
      required: true,
      name: "tokenType",
      shortDescription: "<p> Type of the token the print to the console.</p>\n",
      longDescription:
        "<p>Available options:</p>\n<ul>\n<li><code>accessToken</code>: used to access protected services or endpoints</li>\n<li><code>idToken</code>: used to retrieve information about the identity of the bearer (user/other entity)</li>\n<li><code>refreshToken</code>: used to get new token after the current expire</li>\n</ul>\n"
    },
    {
      description: "#### Name of the user pool (as specified in configuration file).",
      allowedTypes: ["string"],
      alias: "upn",
      required: true,
      name: "userPoolName",
      shortDescription: "<p> Name of the user pool (as specified in configuration file).</p>\n"
    },
    {
      description:
