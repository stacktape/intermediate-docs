...
A web application firewall (WAF) can help protect your user pool from common web-based attacks. For more information, see the [Stacktape documentation on web application firewalls](/security-resources/web-app-firewalls/).
