...
Stacktape provides simple integration with [Upstash Kafka topic](/resources/upstash-kafka-topics/#consumer-integration)
or you can also integrate with any custom Kafka cluster and topic.
